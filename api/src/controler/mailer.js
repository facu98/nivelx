...
const buyTemplate = path.join(__dirname, '../mail-template/buy.ejs');
const cancelTemplate = path.join(__dirname, '../mail-template/cancel_order.ejs');
const despachoTemplate = path.join(__dirname, '../mail-template/despacho.ejs');
